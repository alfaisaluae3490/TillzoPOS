#!/usr/bin/env python3
"""Vendor saved! Now: force sync -> verify Vendors sheet has AUDIT-VENDOR-1.
Also investigate HERMES-VENDOR-001 duplicate (seen twice in list)."""
...
# exit vendors -> home -> menu -> force sync
