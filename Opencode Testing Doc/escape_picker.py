#!/usr/bin/env python3
"""Stuck in system file picker again. Kill it: relaunch app, navigate home, sync."""
...
# force-stop picker by launching app
...
# The scanner home has 'Tap to activate scanner'. If we see inventory list instead,
# press back once to get home.
if 'Tap to activate scanner' not in xml and 'Search items' in xml:
