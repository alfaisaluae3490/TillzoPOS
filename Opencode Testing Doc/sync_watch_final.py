#!/usr/bin/env python3
"""Clean home. Menu -> Force Sync -> watch InventoryUpsert logs for the pending upload."""
...
out = d.shell('logcat -d | grep -E "InventoryUpsertUseCase|SyncWorker completed" | tail -5')
