#!/usr/bin/env python3
"""Menu icon is at (992,171) 'More options' — not (1003,254). Click correct coords."""
...
print('fs visible:', fs)
if not fs:
    # menu may be a dropdown; scroll inside it
    d.swipe(540, 1500, 540, 900, duration=0.3)
    time.sleep(1)
    fs = find_bounds(dump(), r'Force Sync')
    print('after scroll fs:', fs)
