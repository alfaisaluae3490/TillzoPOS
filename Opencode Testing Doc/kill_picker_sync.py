#!/usr/bin/env python3
"""File picker is a SEPARATE activity on top. Kill it via back presses then relaunch app cleanly."""
...
# press back until picker gone
for _ in range(3):
    xml = dump()
    if 'FILES ON DOWNLOADS' not in xml:
        break
    d.press('back')
    time.sleep(2)
